---
name: pr-writer
description: ALWAYS use this skill when creating or updating pull requests — never create or edit a PR directly without it. Follows Taskless conventions for PR titles, descriptions, and issue references. Trigger on any create PR, open PR, submit PR, make PR, update PR title, update PR description, edit PR, push and create PR, prepare changes for review task, or request for a PR writer.
---

# PR Writer

Create pull requests following Taskless' engineering practices.
...
Found while investigating TSKL-5678.
...
This prepares for adding new validation rules in TSKL-9999 without
