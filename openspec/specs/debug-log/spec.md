...
## Purpose
Defines the script's own log of the running Firebot session, the header that identifies the script and host versions and the redacted configuration, and the script configuration page button that copies both to the clipboard for a bug report.
## Requirements
